...
const unifiedStackMap = buildStackMap(state);

const wheelCenter = {
  x: RING_SIZE / 2,
  y: RING_SIZE / 2,
};
const debugPig = state.pieces["P1"]["pig"];

if (!debugPig.inLimbo) {
  const debugBase = piecePosition(debugPig.pos, size);

  console.log("🔴 PIG P1 base:", debugBase, "pos:", debugPig.pos);
  console.log("🟢 wheelCenter:", wheelCenter);
